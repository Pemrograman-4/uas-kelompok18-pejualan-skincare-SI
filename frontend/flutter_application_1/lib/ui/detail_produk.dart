...
class _detail_produk_viewState extends State<detail_produk_view> {
            ...
            Padding(
              ...
              child: Center(
                child: Container(
                    ...
                    child: Image.asset('assets/edit-data.jpg')),
              ),
            ),
            const Padding(
  ...
  void setdata() async {
    ...
    namaProduk_skincare.text = prefs.getString('namaProduk').toString();
    jenis_skincare.text = prefs.getString('jenis').toString();
    stok_skincare.text = prefs.getString('stok').toString();
    harga_skincare.text = prefs.getString('harga').toString();
    deskripsi_skincare.text = prefs.getString('deskripsi').toString();
  }
